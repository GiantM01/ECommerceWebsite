...
<%@page import="com.mycompany.ecommercewebsite.helper.Helper"%>
<%@page import="com.mycompany.ecommercewebsite.entities.Category"%>
<%@page import="com.mycompany.ecommercewebsite.dao.CategoryDao"%>
<%@page import="java.util.List"%>
<%@page import="com.mycompany.ecommercewebsite.entities.Product"%>
<%@page import="com.mycompany.ecommercewebsite.dao.ProductDao"%>
<%@page import="com.mycompany.ecommercewebsite.helper.FactoryProvider"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>EcommerceWebsite-Home</title>
